...
@ELSE
      INTEGER*8 FUNCTION P2AL(ITEM1, ITEM2, NITEMS)
@ENDIF
      INTEGER ITEM1, ITEM2, NITEMS
...
@ELSE
      INTEGER*8 BASEAD, P2MEMA, M2VLOC
      INTEGER*8 ISIZE
@ENDIF
...
@ELSE
      INTEGER*8 FUNCTION P2CAL(ITEM1, ITEM2, NITEMS)
@ENDIF
      CHARACTER*(*) ITEM1, ITEM2
      INTEGER NITEMS
...
@IF LINUX64 | LINUX32
      ...
      INTEGER (KIND=8) ISIZE
@ELSE
      INTEGER*8 BASEAD, P2MEMA, M2CLOC
      INTEGER*8 ISIZE
@ENDIF
...
@ELSE
      INTEGER*8 FUNCTION P2MEMA(BASEAD, ISIZE, NITEMS)
@ENDIF
@IF LINUX64 | LINUX32
      INTEGER (KIND=8) BASEAD, ISIZE
@ELSE
      INTEGER*8 BASEAD, ISIZE
@ENDIF
      INTEGER NITEMS
...
@ELSE
      INTEGER*8 NBYTES, START, ASTART, AIX, BSTART, BIX
@ENDIF
      LOGICAL M2MEMA
      CHARACTER*16 LINE
...
@ELSE
      INTEGER*8 START, BASEAD, NBYTES, ISIZE
      INTEGER*8 ASTART, BSTART, BIX
@ENDIF
...
@ELSE
      INTEGER*8 IBK(7)
      INTEGER*8 START, NBYTES, BASEAD, ISIZE, ASTART
@ENDIF
